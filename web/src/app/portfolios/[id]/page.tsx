...
async function load(id: string) {
  try {
    ...
    return {
      positions: detail.portfolio.positions as Position[],
      ingests: ingests as IngestRun[],
      name: detail.portfolio.name,
      baseCcy: detail.portfolio.baseCcy,
    };
  } catch {
    return {
      positions: [] as Position[],
      ingests: [] as IngestRun[],
      name: "Portfolio",
      baseCcy: "USD",
    };
  }
