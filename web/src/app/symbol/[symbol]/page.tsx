...
async function load(symbol: string) {
  ...
  return { id: 'virtual', name: upper, baseCcy: 'USD', createdAt: new Date().toISOString(), positions: [ { id: `virtual-${upper}`, portfolioId: 'virtual', symbol: upper, quantity: 0, avgCost: 0, createdAt: new Date().toISOString() } ] } as any;
}
